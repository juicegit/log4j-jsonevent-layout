...
public class JSONEventLayoutV1 extends AbstractStringLayout {
	...
	/**
	 * @param locationInfo
	 * 	If "true", includes the location information in the generated JSON, defaults to false.
	 * @param userFields
	 * 	User fields for logstash, e.g. {@code field1:value1,field2:value2}. Note: system properties have precedence over
	...
	private Map<String, Object> createUserFields(String log4jPropertyUserFields) {
		...
		if (systemPropertyUserFields != null) {
			LOGGER.debug("["+this.whoami+"] Adding user fields from system property: " + systemPropertyUserFields);
